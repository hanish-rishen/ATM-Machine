...
/*
 This function will generate a 4-digit random number that is considered as PIN
*/
void pinGeneration(void) {
    FILE *fp;
...
/*
 This function is used to remove the oldest transaction when 10 transactions are made
*/
